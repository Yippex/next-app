  ...
  return (
    <div className="bg-gray-100">
      ...
      <section className="p-5 md:px-20">
        ...
        <Image src='/photo.avif' alt="" width={200} height={200}  id='img' className=" object-center mt-3 my-0 mx-auto  rounded-full md:rounded-lg " />
